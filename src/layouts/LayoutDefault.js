...
const LayoutDefault = (props) => {
  ...
  return (
    ...
    <ul className="list-reset float-end" style={{marginRight:'7%'}}>
    <li>
          <a ref={targetEmail} onClick={() => setShowEmail(!showEmail)} style={{cursor:'pointer'}}>
            <svg
              width="36"
              height="36"
              viewBox="0 0 25 25"
    ...
    <Overlay target={target.current} show={show} placement="bottom" style={{backgroundColor:'white'}}>
        {(props) => (
      ...
      <Overlay target={targetEmail.current} show={showEmail} placement="bottom" style={{backgroundColor:'white'}}>
        {(props) => (
          <Tooltip id="overlay-example" {...props}>
