...
const Caraousel = ({
    ...
    const maxSteps = carouselImages && carouselImages.length ? carouselImages.length : 0;

 

      const handleNext = () => {
        if(activeStep == carouselImages.length-1){
            setActiveStep(0);
        }
        else{
            setActiveStep((prevActiveStep) => prevActiveStep + 1);
        }
        // if(activeStep == testimonialData.length-1){
        //     setActiveStep(0);
        // }
        // else{
        //     setActiveStep((prevActiveStep) => prevActiveStep + 1);
      ...
      const handleBack = () => {
        if(activeStep == 0){
            setActiveStep(carouselImages.length-1);
        }
        else{
            setActiveStep((prevActiveStep) => prevActiveStep - 1);
        }
        // if(activeStep == 0){
        //     setActiveStep(testimonialData.length-1);
        // }
        // else{
        //     setActiveStep((prevActiveStep) => prevActiveStep - 1);
        // }
